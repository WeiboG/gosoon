...
public class CartEntity extends BaseEntity{
	...
	public static final String CART_GOODS_ATTR_NAME = "attr_name";
	public static final String CART_GOODS_ATTR_VALUE = "attr_value";
	public static final String CART_STOCK = "cart_stock";
